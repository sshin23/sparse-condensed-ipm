...
programs by inspecting the computation graph and applying chain rules,
...
\ref{eqn:pattern-2} and \ref{eqn:pattern-3} are less effective as they
require such manipulations, they still can be significantly
...
factorization, which is standard in the state-of-the-art IPM
...
in MadNLP.jl, a port of Ipopt in Julia Language.
...
SIMDiff.jl obtaining the derivative functions specifically compiled
