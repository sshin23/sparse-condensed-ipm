...
efficient implementation of GPU-accelerated parallel AD, leading to a
50x speedup compared to existing tools for large-scale
...
KKT systems of NLPs without numerical pivoting, thus allowing the
solution of sparse, large-scale NLPs (with a prominent example being
AC OPFs) on GPUs.
